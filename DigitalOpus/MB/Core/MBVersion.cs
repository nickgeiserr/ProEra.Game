...
// Type: DigitalOpus.MB.Core.MBVersion
...
namespace DigitalOpus.MB.Core
{
  public class MBVersion
  {
    ...
    private static MBVersionInterface _CreateMBVersionConcrete() => (MBVersionInterface) Activator.CreateInstance(typeof (MBVersionConcrete));
    ...
    public static UnityEngine.Object[] FindSceneObjectsOfType(System.Type t)
    {
      if (MBVersion._MBVersion == null)
        MBVersion._MBVersion = MBVersion._CreateMBVersionConcrete();
    ...
    public static void GetBlendShapeFrameVertices(
      Mesh m,
      int shapeIndex,
      int frameIndex,
      Vector3[] vs,
    ...
    public static void AddBlendShapeFrame(
      Mesh m,
      string nm,
      float wt,
      Vector3[] vs,
