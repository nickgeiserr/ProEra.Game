...
// Type: Analytics.BossModeGameCompletedArgs
...
namespace Analytics
{
  public class BossModeGameCompletedArgs : AnalyticEventArgs
  {
    public BossModeGameCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.BossModeGameCompleted.ServiceName();
