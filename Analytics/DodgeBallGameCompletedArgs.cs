...
// Type: Analytics.DodgeBallGameCompletedArgs
...
namespace Analytics
{
  public class DodgeBallGameCompletedArgs : AnalyticEventArgs
  {
    public DodgeBallGameCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.DodgeBallGameCompleted.ServiceName();
