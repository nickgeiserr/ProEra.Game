...
// Type: Analytics.ExhibitionGameCompletedArgs
...
namespace Analytics
{
  public class ExhibitionGameCompletedArgs : AnalyticEventArgs
  {
    public ExhibitionGameCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.ExhibitionGameCompleted.ServiceName();
