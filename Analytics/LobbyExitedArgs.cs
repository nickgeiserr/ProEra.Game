...
// Type: Analytics.LobbyExitedArgs
...
namespace Analytics
{
  public class LobbyExitedArgs : AnalyticEventArgs
  {
    public LobbyExitedArgs(
    ...
    public override string EventName => AnalyticEventName.LobbyExited.ServiceName();
