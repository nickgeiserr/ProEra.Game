...
// Type: Analytics.TwoMinuteDrillGameCompletedArgs
...
namespace Analytics
{
  public class TwoMinuteDrillGameCompletedArgs : AnalyticEventArgs
  {
    public TwoMinuteDrillGameCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.TwoMinuteDrillGameCompleted.ServiceName();
