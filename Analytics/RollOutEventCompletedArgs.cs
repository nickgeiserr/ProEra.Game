...
// Type: Analytics.RollOutEventCompletedArgs
...
namespace Analytics
{
  public class RollOutEventCompletedArgs : AnalyticEventArgs
  {
    public RollOutEventCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.RollOutEventCompleted.ServiceName();
