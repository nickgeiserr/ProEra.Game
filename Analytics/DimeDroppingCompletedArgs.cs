...
// Type: Analytics.DimeDroppingCompletedArgs
...
namespace Analytics
{
  public class DimeDroppingCompletedArgs : AnalyticEventArgs
  {
    public DimeDroppingCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.DimeDroppingCompleted.ServiceName();
