...
// Type: Analytics.ThrowingGameCompletedArgs
...
namespace Analytics
{
  public class ThrowingGameCompletedArgs : AnalyticEventArgs
  {
    public ThrowingGameCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.ThrowingGameCompleted.ServiceName();
