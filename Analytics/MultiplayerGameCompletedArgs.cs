...
// Type: Analytics.MultiplayerGameCompletedArgs
...
namespace Analytics
{
  public class MultiplayerGameCompletedArgs : AnalyticEventArgs
  {
    public MultiplayerGameCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.MultiplayerGameCompleted.ServiceName();
