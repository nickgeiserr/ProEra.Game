...
// Type: Analytics.RunAndShootCompletedArgs
...
namespace Analytics
{
  public class RunAndShootCompletedArgs : AnalyticEventArgs
  {
    public RunAndShootCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.RunAndShootCompleted.ServiceName();
