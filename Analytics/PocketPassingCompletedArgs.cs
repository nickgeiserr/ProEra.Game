...
// Type: Analytics.PocketPassingCompletedArgs
...
namespace Analytics
{
  public class PocketPassingCompletedArgs : AnalyticEventArgs
  {
    public PocketPassingCompletedArgs(
    ...
    public override string EventName => AnalyticEventName.PocketPassingCompleted.ServiceName();
