...
// Type: TB12.AppStates.ThrowGameState
...
{
  [CreateAssetMenu(menuName = "TB12/States/ThrowGameState")]
  public class ThrowGameState : GameState
  {
    [SerializeField]
    ...
    private ThrowLevel _currentLevel;
    private readonly RoutineHandle _retryRoutine = new RoutineHandle();

    public override EAppState Id => EAppState.kThrowGame;

    public event Action<ThrowLevel> OnTrainingStarted;
    ...
    protected override void OnEnterState()
    {
      ...
      this._currentLevel = this._gameplayData.GetThrowChallenge(AppState.LevelId);
      if (this._currentLevel == null)
        return;
      Action<ThrowLevel> onTrainingStarted = this.OnTrainingStarted;
