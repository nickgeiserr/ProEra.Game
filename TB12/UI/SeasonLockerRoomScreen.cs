...
// Type: TB12.UI.SeasonLockerRoomScreen
...
namespace TB12.UI
{
  public class SeasonLockerRoomScreen : UIScreen
  {
    public override uint id { get; } = Convert.ToUInt32((object) EScreenParent.kSeasonLockerRoom);
    ...
    {
      SeasonLockerRoomScreen lockerRoomScreen = this;
